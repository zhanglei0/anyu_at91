...
static int
tvp5150_enum_mbus_fmt(struct v4l2_subdev *sd, unsigned index,
...
static struct soc_camera_ops soc_tvp5150_ops = {
			 ...
			 const struct i2c_device_id *id)
{
	struct tvp5150 *core;
	struct v4l2_subdev *sd;
	/* treat TVP5150 as a soc_camera_device */
	...
	if (!icl) {
		dev_err(&adapter->dev,
			"TVP5150: Missing platform_data for driver\n");
		return -EINVAL;
	}
	icd->ops = &soc_tvp5150_ops;
