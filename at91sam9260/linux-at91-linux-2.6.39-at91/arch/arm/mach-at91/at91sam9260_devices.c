...
void __init at91_add_device_isi(struct isi_platform_data * data)
{
	...
	if (!data)
		return;
	isi_data = *data;
	at91_set_B_periph(AT91_PIN_PB20, 1);	/* ISI_D0 */
	at91_set_B_periph(AT91_PIN_PB21, 1);	/* ISI_D1 */
	at91_set_B_periph(AT91_PIN_PB22, 1);	/* ISI_D2 */
	at91_set_B_periph(AT91_PIN_PB23, 1);	/* ISI_D3 */
	at91_set_B_periph(AT91_PIN_PB24, 1);	/* ISI_D4 */
	at91_set_B_periph(AT91_PIN_PB25, 1);	/* ISI_D5 */
	at91_set_B_periph(AT91_PIN_PB26, 1);	/* ISI_D6 */
	at91_set_B_periph(AT91_PIN_PB27, 1);	/* ISI_D7 */
	at91_set_B_periph(AT91_PIN_PB28, 1);	/* ISI_PCK */
	at91_set_B_periph(AT91_PIN_PB30, 0);	/* ISI_HSYNC */
	at91_set_B_periph(AT91_PIN_PB29, 0);	/* ISI_VSYNC */
	at91_set_A_periph(AT91_PIN_PB31, 0);	/* ISI_MCK (PCK1) */
