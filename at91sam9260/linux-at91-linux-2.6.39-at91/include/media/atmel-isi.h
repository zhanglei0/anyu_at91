...
#define ISI_IDR	   0x10
#define ISI_IMR    0x14
#define ISI_PSIZE  0X20
#define ISI_PDECF  0X24

#define ISI_PPFBD  0x28
//#define ISI_CDBA   0x2c
#define ISI_Y2R_SET0    0x30
#define ISI_Y2R_SET1    0X34
#define ISI_R2Y_SET0    0X38
#define ISI_R2Y_SET1    0X3C
#define ISI_R2Y_SET2    0x40
...
/* Constants for FRATE(ISI_V2 compain with 9260)  */

#define ISI_IER_ENABLE_SOF			(1 << 0)
//#define ISI_IER_ENABLE_FO_C_EMP     (1 << 8)
...
//#define ISI_CFG1_ENABLE_CODEC			(1 << 15)
...
#define ISI_SR_SOF				(1 << 0)
//#define ISI_SR_FO_C_EMP			(1 << 8)
#define ISI_SR_SRST		    (1 << 2)
